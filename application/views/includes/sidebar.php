            ...
            <nav id="sidebar">
                ...
                <div class="sidebar_blog_2">
                    ...
                    <ul class="list-unstyled components">
                        ...
                        <li class="active">
                            <a href="#labelP" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                                    class="fas fa-barcode purple_color2"></i>
                                <span>LABEL PRINTING</span></a>
                            <ul class="collapse list-unstyled" id="labelP">
                                <li><a href="<?= base_url('label') ?>"><i class="fas fa-tasks orange_color"></i>
                                        <span>OUTTER LABEL</span></a></li>
                                        <?php $user = $this->session->userdata();
                        if ($user['role'] == 'admin') { ?>
                        <li class="active">
                        ...
                        <li class="active">
                            ...
                            <ul class="collapse list-unstyled" id="material">
                                <li><a href="<?= base_url('rawmaterial/less_rawmaterial') ?>"><i
                                            class="fas fa-tasks orange_color"></i>
                                        <span>MANAGE</span></a></li>
